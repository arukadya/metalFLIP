...
//  metalFLIP
//
//  Created by 須之内俊樹 on 2023/03/17.
//

#include "metal-cpp.hpp"
#include <cassert>
...
class Renderer
{
    public:
        ...
        ~Renderer();
        void buildShaders();
        void buildBuffers(simd::float3* vertices);
...
void Renderer::buildBuffers(simd::float3* vertices)
{
    const size_t NumVertices = 3;

    simd::float3 *positions = vertices;
//    {
//        { -0.8f,  0.8f, 0.0f },
//        {  0.0f, -0.8f, 0.0f },
//        { +0.8f,  0.8f, 0.0f }
//    };
    ...
    simd::float3 colors[NumVertices] = {0};
//    {
//    {
//        {  1.0, 0.3f, 0.2f },
//        {  0.8f, 1.0, 0.0f },
